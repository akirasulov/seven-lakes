...
return [
    ...
    'enum' => 'Атрибути интихобшудаи :attribute беэътибор аст.',
    ...
    'not_in' => 'Атрибути интихобшудаи :attribute беэътибор аст.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Хусусияти додашудаи :дар ихроҷи маълумот пайдо шуд. Лутфан :attribute дигарро интихоб кунед.',
    ],
    ...
    /*
    |--------------------------------- ----------------------------------
    | Хатҳои забони тасдиқкунии фармоишӣ
    |--------------------------------- ----------------------------------
    |
    | Дар ин ҷо шумо метавонед паёмҳои тасдиқкунии фармоиширо барои атрибутҳо бо истифода аз
    | конвенсияи "attribute.rule" барои номи сатрҳо. Ин онро зуд ба амал меорад
    | хати махсуси забони фармоиширо барои қоидаи аттрибутӣ муайян кунед.
    |
     */
    ...
    /*
    |--------------------------------- ----------------------------------
    | Аттрибутҳои тасдиқи фармоишӣ
    |--------------------------------- ----------------------------------
    |
    | Хатҳои зерини забон барои иваз кардани ҷойнишини атрибутҳои мо истифода мешаванд
    | ба ҷои он чизе, ки барои хонандагон дӯстона бештар ба монанди "Суроғаи почтаи электронӣ"
    | аз "почтаи электронӣ". Ин танҳо ба мо кӯмак мекунад, ки паёми худро бештар баён кунем.
    |
     */
